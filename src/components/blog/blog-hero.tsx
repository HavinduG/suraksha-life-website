...
import { BookOpen, PenTool, Coffee, FileText, Share2 } from "lucide-react"; // Blog icons
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
                <BookOpen className="floating-particle absolute top-[15%] left-[20%] text-[#05668D]" size={36} />
                <PenTool className="floating-particle absolute top-[65%] left-[15%] text-[#02C39A]" size={32} />
                <Coffee className="floating-particle absolute bottom-[25%] right-[20%] text-[#ef4444]" size={40} />
                <FileText className="floating-particle absolute top-[25%] right-[25%] text-[#05668D]" size={28} />
                <Share2 className="floating-particle absolute bottom-[20%] left-[40%] text-[#02C39A]" size={24} />
            ...
            <div className="container relative z-10 px-4 text-center">
                ...
                >
                    Stay informed with our <span className="text-[#02C39A] font-bold">stories</span>, <span className="text-[#0097a7] font-bold">insights</span>, and <span className="text-[#ef4444] font-bold">expert advice</span>.
                </p>
            </div>
        </section>
    );
