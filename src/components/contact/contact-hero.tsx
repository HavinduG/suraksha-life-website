...
import { Phone, Mail, MapPin, MessageSquare, Send } from "lucide-react"; // Contact icons
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
                <Phone className="floating-particle absolute top-[15%] left-[20%] text-[#05668D]" size={36} />
                <Mail className="floating-particle absolute top-[65%] left-[15%] text-[#02C39A]" size={32} />
                <MapPin className="floating-particle absolute bottom-[25%] right-[20%] text-[#ef4444]" size={40} />
                <MessageSquare className="floating-particle absolute top-[25%] right-[25%] text-[#05668D]" size={28} />
                <Send className="floating-particle absolute bottom-[20%] left-[40%] text-[#02C39A]" size={24} />
            ...
            <div className="container relative z-10 px-4 text-center">
                ...
                >
                    We are here to <span className="text-[#02C39A] font-bold">listen</span>, <span className="text-[#0097a7] font-bold">help</span>, and <span className="text-[#ef4444] font-bold">care</span> for you.
                </p>
            </div>
        </section>
    );
